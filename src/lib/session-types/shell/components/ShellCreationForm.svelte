...
<script>
	...
	// Available shells
	const availableShells = ['/bin/bash', '/bin/sh', '/bin/zsh', '/bin/fish', '/usr/bin/fish'];
	...
	<div class="form-body">
		...
		<div class="form-group">
			<div class="env-header">
				...
				<button type="button" class="toggle-env" onclick={() => (showEnvEditor = !showEnvEditor)}>
			...
			{#if showEnvEditor}
				<div class="env-editor">
					...
					{:else}
						<div class="env-empty">No custom environment variables set</div>
					{/if}
				</div>
			{/if}
		</div>
		...
		<div class="form-group">
			...
			<div class="checkbox-group">
				<label class="checkbox-label">
					<input type="checkbox" class="checkbox-input" bind:checked={loginShell} />
					<span class="checkbox-text">Login shell</span>
				</label>
			</div>
			<div class="help-text">Start shell as a login shell (loads login configuration files)</div>
		</div>
