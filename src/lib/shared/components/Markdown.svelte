...
<style>
	...
	.markdown-content :global(h1) { font-size: var(--font-size-5); }
	.markdown-content :global(h2) { font-size: var(--font-size-4); }
	.markdown-content :global(h3) { font-size: var(--font-size-3); }
	.markdown-content :global(h4) { font-size: var(--font-size-2); }
	.markdown-content :global(h5) { font-size: var(--font-size-1); }
	.markdown-content :global(h6) { font-size: var(--font-size-0); }
