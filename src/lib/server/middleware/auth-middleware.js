...
export class AuthMiddleware {
  ...
  getStatistics() {
    ...
    const authenticatedSockets = Array.from(this.socketAuthState.values())
      .filter(state => state.state === AuthState.AUTHENTICATED).length;
    
    const totalAttempts = Array.from(this.authAttempts.values())
