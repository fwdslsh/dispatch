...
export class SessionHandler {
	...
	constructor(dependencies = {}) {
		...
		this.terminalService =
			dependencies.terminalService || dependencies.terminalManager || new TerminalManager();
		this.storageService =
			dependencies.storageService || dependencies.storageManager || storageManager;
		...
		try {
			...
			if (projectId) {
				...
				try {
					...
					if (callback)
						callback(createErrorResponse(`Failed to create default project: ${err.message}`));
					return;
				}
			}
