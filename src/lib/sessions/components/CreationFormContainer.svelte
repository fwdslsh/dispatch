...
<main class="form-container" aria-label="Session creation form">
	...
	{:else if isProjectRequired(selectedType)}
		...
		<div class="warning-state">
			...
			<p>
				The <strong>{selectedType.name}</strong> session type requires a project to be selected. Please
	...
	{:else}
		...
		<div class="error-state">
			...
			<p>
				The session type <strong>{selectedType.name}</strong> (ID: {selectedType.id}) is not
