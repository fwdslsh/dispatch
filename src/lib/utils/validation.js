...
import { TERMINAL_CONFIG, VALIDATION_CONFIG, ERROR_CODES } from '../config/constants.js';
...
export const validators = {
  ...
  input: (data) => {
    ...
    if (data.length > TERMINAL_CONFIG.MAX_INPUT_LENGTH) {
      ...
      console.warn(`Input truncated from ${data.length} to ${TERMINAL_CONFIG.MAX_INPUT_LENGTH} characters`);
