...
```svelte
<AuthenticationStep onComplete={handleAuthComplete} error={authError} />
```
...
```svelte
<WorkspaceCreationStep onComplete={handleWorkspaceCreated} initialPath="/workspace/my-project" />
```
