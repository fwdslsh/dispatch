...
import { CommandService } from '../../src/lib/session-types/claude/components/command-menu/CommandService.js';
...
describe('CommandService', () => {
	...
	describe('Command Execution', () => {
		...
		it('should throw error for non-existent command execution', async () => {
			await expect(commandService.executeCommandByName('non-existent')).rejects.toThrow(
