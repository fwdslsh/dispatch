...
<conditional-block task-condition="html-css-picocss" context-check="html-css-style">
IF current task involves writing or updating HTML, CSS, or PicoCSS:
  ...
  ELSE:
    <context_fetcher_strategy>
      IF current agent is Claude Code AND context-fetcher agent exists:
        ...
        REQUEST: "Get CSS and PicoCSS rules from code-style/css-style.md"
