...
```css
--text: /* Primary text */
--muted: /* Secondary text (75% opacity, WCAG AA compliant) */
...
--primary-bright: /* Brighter variant */
--primary-dim: /* Dimmer variant */
...
**Font Families:**
```css
--font-mono: /* Monospace (Share Tech Mono) */
--font-sans: /* Sans-serif (Exo 2) */
...
.form-status--warning { color: var(--warn); }
```
