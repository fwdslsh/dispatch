...
test.describe('Desktop Screenshots', () => {
  ...
  test('Desktop - Create Workspace Modal', async ({ page }) => {
    ...
    await page.screenshot({ path: 'screenshots/desktop-create-workspace-modal.png', fullPage: true });
  });
  ...
  test('Desktop - Session Header Actions', async ({ page }) => {
    ...
    await page.screenshot({ path: 'screenshots/desktop-session-header-actions.png', fullPage: true });
  });
  ...
  test('Desktop - Workspace Switcher', async ({ page }) => {
    ...
    const workspaceSelector = page.locator('.workspace-selector, select, [aria-label*="workspace"]').first();
...
test.describe('Mobile Screenshots', () => {
  ...
  test('Mobile - Create Workspace Modal', async ({ page }) => {
    ...
    await page.waitForTimeout(500);
    await page.screenshot({ path: 'screenshots/mobile-create-workspace-modal.png', fullPage: true });
  });
  ...
  test('Mobile - Session Actions Menu', async ({ page }) => {
    ...
    const moreButton = page.locator('button[aria-label*="more"], button[aria-label*="menu"], .session-menu').first();
