...
test.describe('Projects Management', () => {
  ...
  test('should have create new project functionality', async ({ page }) => {
    ...
    const createForm = page.locator('form:has(input[placeholder*="project" i]), .create-project-form');
  ...
  test('should create a new project', async ({ page }) => {
    ...
    const nameInput = page.locator('input[placeholder*="name" i], input[placeholder*="project" i], [data-testid="project-name-input"]').first();
  ...
  test('should handle project deletion if supported', async ({ page }) => {
    ...
    const deleteButton = page.locator(`button:has-text("Delete"), .delete-btn, [data-testid="delete-project"]`);
  ...
  test('should handle empty projects state', async ({ page }) => {
    ...
    const hasEmptyState = await emptyState.isVisible();
    const hasProjects = await projectsList.isVisible() && await projectsList.locator('.project-item').count() > 0;
