...
test.describe('Command Palette and Keyboard Shortcuts', () => {
  ...
  test('should show command palette with click', async ({ page }) => {
    ...
    const commandButton = page.locator('button:has-text("Command"), button:has-text("Palette"), [data-testid="command-palette-btn"]');
  ...
  test('should navigate commands with keyboard', async ({ page }) => {
    ...
    if (await commandPalette.isVisible()) {
      ...
      if (itemCount > 1) {
        ...
        const selectedItem = commandPalette.locator('.command-item.selected, .command-item[aria-selected="true"]');
  ...
  test('should categorize commands', async ({ page }) => {
    ...
    if (await commandPalette.isVisible()) {
      ...
      const categories = commandPalette.locator('.command-category, .category, [data-testid="command-category"]');
  ...
  test('should show recent commands', async ({ page }) => {
    ...
    if (await commandPalette.isVisible()) {
      ...
      const recentSection = commandPalette.locator('.recent-commands, [data-testid="recent-commands"]');
  ...
  test('should show keyboard shortcut hints', async ({ page }) => {
    ...
    const helpButton = page.locator('button:has-text("Help"), button:has-text("?"), [data-testid="help"]');
  ...
  test('should handle command palette on mobile', async ({ page }) => {
    ...
    const commandButton = page.locator('button:has-text("Commands"), [data-testid="command-palette-btn"]');
