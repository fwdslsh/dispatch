...
async function measureBuildPerformance() {
    ...
    try {
        ...
        console.log(`   Incremental build time: ${((incrementalEnd - incrementalStart) / 1000).toFixed(2)}s`);
...
async function estimateMemoryUsage() {
    ...
    console.log(`   Total estimated reactive memory: ~${(estimatedStateMemory + estimatedDerivedMemory)} bytes`);
